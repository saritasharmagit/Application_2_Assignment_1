...
class Assignment_1Test2 {
	...
	void test() {
		...
		String s = obj.matches("theKingthe",book);
		assertEquals("theKingthe",s);
		
		String s1 = obj.generatePassword(book);
		for(int i=0;i<s1.length();i++) {
			assertEquals("king and Queen",s1);
		}
		
		/*String[] s2 = obj.generateWords();
		for(int i=0;i<s2.length;i++) {
			assertTrue(s2[i]=="king");
		}*/
